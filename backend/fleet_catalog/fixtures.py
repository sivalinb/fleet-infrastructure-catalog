...
from .models import Audit, Source, utcnow
    ...
    for slug, name, owner, nodes, dependencies in services:
        catalog.append(
            record(
                ...
                repository="https://github.com/sivalinb/fleet-infrastructure-catalog",
                description="Fictional service metadata for ownership and dependency reconciliation.",
            )
        )
        kube.append(
            record(
